...
int main()
{
	try {
		...
		std::wstring jpg_path = L"images/he057.jpg";
		//CImg<unsigned char> image_jpg("images/he057.jpg");
		//std::cout<<"D:/tmp/人像/guyadong-1.jpg"<<std::endl;
		const char *input_jpg_file = "images/he057.jpg";
		const char *output_jpg_file = "images/he057-out.jpg";
		const char *output2_jpg_file = "images/he057-out2.jpg";
		const char *output3_jpg_file = "images/he057-out3.jpg";
		const char *output4_jpg_file = "images/he057-out4.jp2";
